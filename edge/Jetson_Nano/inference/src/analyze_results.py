'''
Take the file '../data/latencies.txt and get the average and standard deviation of the latencies.
...
latencies = np.loadtxt('../data/latencies.txt')
...
for latency in latencies:
    if latency > average_latency + 3 * std_deviation:
        # print("Anomaly detected at latency:", latency)
        num_anomalies += 1
